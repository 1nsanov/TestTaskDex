...
namespace TestTaskDex.Migrator.Migrations
{
    ...
    [Migration("20230918072747_AdvertisementAddIndices")]
    partial class AdvertisementAddIndices
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TestTaskService.Domain.Entities.Advertisements.Advertisement", b =>
                {
                    ...
                    b.HasIndex("ExpireDate")
                        .HasDatabaseName("IX_Advertisement_ExpireDate");

                    b.HasIndex("Number")
                        .IsUnique();

                    b.HasIndex("Rate")
                        .HasDatabaseName("IX_Advertisement_Rate");
